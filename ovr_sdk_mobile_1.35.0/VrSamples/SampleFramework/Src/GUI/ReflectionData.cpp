...
ovrEnumInfo HorizontalJustification_Enums[] = {{"HORIZONTAL_LEFT", 0},
                                               {"HORIZONTAL_CENTER", 1},
                                               {"HORIZONTAL_RIGHT", 2}};
OVR_VERIFY_ARRAY_SIZE(HorizontalJustification_Enums, 3);

ovrEnumInfo VerticalJustification_Enums[] = {{"VERTICAL_BASELINE", 0},
                                             {"VERTICAL_CENTER", 1},
...
ovrEnumInfo VRMenuObjectType_Enums[] = {{"VRMENU_CONTAINER", 0},
                                        {"VRMENU_STATIC", 1},
                                        {"VRMENU_BUTTON", 2},
                                        {"VRMENU_MAX", 3}};
OVR_VERIFY_ARRAY_SIZE(VRMenuObjectType_Enums, VRMENU_MAX + 1);

ovrEnumInfo VRMenuObjectFlag_Enums[] = {{"VRMENUOBJECT_FLAG_NO_FOCUS_GAINED", 0},
...
ovrEnumInfo VRMenuObjectInitFlag_Enums[] = {{"VRMENUOBJECT_INIT_ALIGN_TO_VIEW", 0},
                                            {"VRMENUOBJECT_INIT_FORCE_POSITION", 1}};
OVR_VERIFY_ARRAY_SIZE(VRMenuObjectInitFlag_Enums, 2);

ovrEnumInfo SurfaceTextureType_Enums[] = {{"SURFACE_TEXTURE_DIFFUSE", 0},
...
ovrEnumInfo VRMenuEventType_Enums[] = {{"VRMENU_EVENT_FOCUS_GAINED", 0},
...
ovrEnumInfo EventDispatchType_Enums[] = {{"EVENT_DISPATCH_TARGET", 0},
...
ovrMemberInfo ovrSoundLimiter_Reflection[] = {{"LastPlayTime",
                                               "double",
                                               NULL,
                                               ovrTypeOperator::NONE,
