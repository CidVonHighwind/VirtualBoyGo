...
public class MainActivity extends android.app.NativeActivity
  ...
  static {
    ...
    System.loadLibrary("vr360videoplayer");
  }

  public static final String TAG = "Vr360VideoPlayer";
    ...
    if (externalStoragePermissionGranted) {
      runOnUiThread(
          new Thread() {
            ...
            public void run() {
              Log.d(TAG, "startMovieFromNative");
              startMovieAfterPermissionGranted(movieFilePath);
            }
          });
    } else {
  ...
  public void startMovieAfterPermissionGranted(String pathName) {
    Log.v(TAG, "startMovieAfterPermissionGranted " + pathName);
    ...
    Log.v(TAG, "startMovieAfterPermissionGranted returning");
  }
